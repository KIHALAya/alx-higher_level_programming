...
"""
3-my_safe_filter_states.py - Script that takes in arguments and displays all
values in the states table of hbtn_0e_0_usa where name matches the argument,
ensuring it is safe from MySQL injections.

Usage:./3-my_safe_filter_states.py <username> <password> <database> <statename>
...
if __name__ == "__main__":
    ...
    query = """SELECT *
               ...
               ORDER BY id""".format(str(arguments[3]))
