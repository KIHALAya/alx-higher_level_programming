...
class Rectangle:
    ...
    def __str__(self):
        ...
        the rectangle using the print symbol.
        """
        if self.__width == 0 or self.__height == 0:
            return ''

        symbol_row = str(self.print_symbol) * self.__width
        rectangle_representation = [symbol_row for _ in range(self.__height)]
        return '\n'.join(rectangle_representation)

    def __repr__(self):
        """
        Returns a string representation of
        the rectangle to recreate an instance.
        """
        return f"{type(self).__name__}({self.__width}, {self.__height})"

    def __del__(self):
        """
        Deletes an instance of Rectangle and
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: The instance with the larger or equal area.
        """
    ...
    def square(cls, size=0):
        ...
        Returns:
            Rectangle: A new instance representing a square.
        """
